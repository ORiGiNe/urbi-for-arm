...
#
# Copyright (C) 2003, 2006, 2007, 2009, 2010, 2012 Gostai SAS.
#
...
# TC_COMPILER_FLAGS(LANG, VARIABLE, OPTIONS)
# ------------------------------------------
# Check whether the LANG compiler supports all the OPTIONS (space separated).
# If it does append them to VARIABLE.
...
# order.
AC_DEFUN([TC_COMPILER_FLAGS],
[AC_LANG_PUSH([$1])
m4_foreach([AC_Option], [$3],
    [TC_COMPILER_OPTION_IF(AC_Option,
	   [URBI_APPEND_FLAGS([$2], "AC_Option")])])
AC_LANG_POP([$1])
])# TC_COMPILER_FLAGS
...
[TC_COMPILER_FLAGS([C++], [WARNING_CXXFLAGS], [$1])])
